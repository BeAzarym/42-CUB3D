...
/*   Updated: 2024/08/22 11:43:01 by cchabeau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_compute_dda(t_cub *cub);
void	ft_compute_wall_dist(t_cub *cub);
void	ft_draw_texture(t_cub *cub, t_raycast *ray, int x);
